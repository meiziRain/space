...
export default function StartSaturn() {
    ...
    // 漫反射贴图
    this.mapTexture = new THREE.TextureLoader().load(saturn);
    ...
    this.ringShadownTexture = new THREE.TextureLoader().load(saturn_ring);
